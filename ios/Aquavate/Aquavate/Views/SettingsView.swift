...
// MARK: - Connection-Aware Section Header

/// A section header that displays a connection status badge.
/// Used for sections whose contents require a BLE connection.
private struct ConnectionAwareHeader: View {
    let title: String
    ...
    var body: some View {
        NavigationView {
            List {
                ...
                // MARK: - Device Setup (Connection-Aware Card)
                Section {
                    Group {
                        HStack {
                    ...
                    ConnectionAwareHeader(title: "Device Setup", isConnected: isConnected)
                } footer: {
                    if !isConnected {
                ...
                // MARK: - Device Controls (Connection-Aware Card)
                Section {
                    Group {
                        Button {
                    ...
                    ConnectionAwareHeader(title: "Device Controls", isConnected: isConnected)
                } footer: {
                    if !isConnected {
                ...
                // MARK: - Reminder Options (conditional)
