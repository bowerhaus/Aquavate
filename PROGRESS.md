...
**Daily Goal Setting from iOS App (Issue #83)** - [Plan 062](Plans/062-daily-goal-setting.md)
...
```
Resume from PROGRESS.md - working on daily goal setting (Issue #83), code complete, ready for device testing
```
